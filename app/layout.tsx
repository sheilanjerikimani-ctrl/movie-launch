  ...
  return (
    <html lang="en">
      <body className="bg-black text-white antialiased">
        ...
        <style>{`
          .page-bg-photo{position:fixed;inset:0;background-size:cover;background-position:center;z-index:-2;opacity:0.15}
          .page-bg-overlay{position:fixed;inset:0;background:#000000;z-index:-1;opacity:0.9}
        `}</style>
      </body>
    </html>
  );
